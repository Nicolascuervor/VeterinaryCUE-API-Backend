...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(AbstractHttpConfigurer::disable) // Usamos el configurer lambda
        ...
        http
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers(serviciosAdminPath + "/**").hasAuthority(ADMIN)
                        .requestMatchers(HttpMethod.POST, disponibilidadPath + "/generar-slots").hasAuthority(ADMIN)
                        .requestMatchers(HttpMethod.POST, disponibilidadPath + "/jornada").hasAnyAuthority(ADMIN, VETERINARIO)
                        .requestMatchers(HttpMethod.PATCH, disponibilidadPath + "/slots/**").hasAnyAuthority(ADMIN, VETERINARIO)
