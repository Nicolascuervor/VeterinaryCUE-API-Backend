...
CREATE DATABASE IF NOT EXISTS historias_clinicas_service;
...
CREATE DATABASE IF NOT EXISTS agendamiento_service;
...
GRANT ALL PRIVILEGES ON historias_clinicas_service.* TO 'CuervoAdmin'@'%';
...
GRANT ALL PRIVILEGES ON agendamiento_service.* TO 'CuervoAdmin'@'%';
